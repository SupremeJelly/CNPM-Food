...
destinations:
  - name: grafana-cloud-metrics
    ...
    auth:
      type: basic
      username: "2808529"
      password: glc_eyJvIjoiMTU5MzAwMCIsIm4iOiJzdGFjay0xNDQyMTQ4LWludGVncmF0aW9uLWJvbWJhY2xhdC1ib21iYWNsYXQiLCJrIjoicTYzaEZMM1U0YzczMDhtRW12cWtjMTZjIiwibSI6eyJyIjoicHJvZC1hcC1zb3V0aGVhc3QtMSJ9fQ==
...
$valuesYaml | helm upgrade --install --atomic --timeout 300s grafana-k8s-monitoring grafana/k8s-monitoring --namespace "cnpm-food" --create-namespace --values -
