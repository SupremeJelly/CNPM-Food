...
('123 Lê Văn Sỹ, Quận 3, TP.HCM', 'burger_king.png', 'Burger King'),
('456 Nguyễn Trãi, Quận 5, TP.HCM', 'kfc.jpeg', 'KFC'),
('789 Trần Hưng Đạo, Quận 1, TP.HCM', 'mcdonald.jpg', 'McDonald''s'),
('101 Phan Xích Long, Phú Nhuận, TP.HCM', 'pizza_hut.png', 'Pizza Hut'),
('202 Điện Biên Phủ, Bình Thạnh, TP.HCM', 'domino.png', 'Domino''s Pizza'),
('303 Nguyễn Thị Minh Khai, Quận 1, TP.HCM', 'lotteria.png', 'Lotteria'),
('404 Cách Mạng Tháng 8, Quận 10, TP.HCM', 'jollibee.jpg', 'Jollibee'),
('505 Võ Văn Tần, Quận 3, TP.HCM', 'subway.png', 'Subway'),
('606 Nguyễn Đình Chiểu, Quận 3, TP.HCM', 'tocotoco.jpg', 'TocoToco'),
('707 Lý Chính Thắng, Quận 3, TP.HCM', 'highland.png', 'Highlands Coffee');
INSERT INTO menu_items (image_url, name, price, stock, restaurant_id) VALUES
('burger_beef_cheese.jpg', 'Burger bò phô mai', 65000, 50, 1),
('burger_spicy_chicken.jpg', 'Burger gà cay', 60000, 40, 4),
('burger_veggie.jpg', 'Burger chay', 55000, 30, 1),
('french_fries.jpeg', 'Khoai tây chiên', 30000, 100, 1),
('fried_chicken_1.jpg', 'Gà rán phần 1 miếng', 35000, 80, 2),
('fried_chicken_2.png', 'Gà rán phần 2 miếng', 65000, 60, 5),
('hotdog_classic.jpg', 'Hotdog truyền thống', 40000, 70, 1),
('hotdog_cheese.jpg', 'Hotdog phô mai', 45000, 60, 1),
('pizza_cheese.jpg', 'Pizza phô mai', 90000, 40, 6),
('pizza_seafood.jpg', 'Pizza hải sản', 110000, 35, 3),
('pizza_sausage.jpg', 'Pizza xúc xích', 95000, 45, 3),
('chicken_nuggets.jpg', 'Nuggets gà', 40000, 90, 2),
('sandwich_ham.jpg', 'Sandwich thịt nguội', 45000, 50, 1),
('sandwich_egg.jpg', 'Sandwich trứng', 40000, 50, 1),
('taco_beef.jpg', 'Taco bò', 50000, 40, 1),
('taco_chicken.jpg', 'Taco gà', 50000, 40, 1),
('salad_grilled_chicken.jpg', 'Salad gà nướng', 55000, 30, 2),
('salad_tuna.jpg', 'Salad cá ngừ', 60000, 30, 2),
('milkshake_chocolate.jpg', 'Sữa lắc socola', 45000, 60, 7),
('milkshake_strawberry.jpg', 'Sữa lắc dâu', 45000, 60, 3);
